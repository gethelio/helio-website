...
export default function Logo() {
  return (
    <Link href="/" className="inline-flex items-center gap-2.5" aria-label="Helio">
      <svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="16" cy="16" r="16" fill="#111929" />
        <g opacity="0.84" clipPath="url(#helio-logo-clip)">
        ...
        <defs>
          <clipPath id="helio-logo-clip">
            <rect width="24.8889" height="29.8667" fill="white" transform="translate(3.55469 1.06641)" />
          </clipPath>
        </defs>
      </svg>
      <span className="hidden md:block font-[family-name:var(--font-geist-sans)] text-[15px] font-semibold tracking-wide text-gray-900 dark:text-white">
        Helio
      </span>
    </Link>
  );
